...
public class RunningState : MovementState
{
    ...
    private void ApplyHorizontalMovement()
    {
        ...
        float acceleration = _controller.MovementConfig.GroundAcceleration;
        float deceleration = _controller.MovementConfig.GroundDeceleration;
        float moveSpeed = _controller.MovementConfig.MovementSpeed;
